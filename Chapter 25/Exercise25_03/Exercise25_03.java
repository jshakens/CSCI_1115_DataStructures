...
public class Exercise25_03 {
  public static void main(String[] args) {
    ...
    BST<String> treeString = new BST<String>();
    treeString.insert("George");
    treeString.insert("Michael");
    treeString.insert("Tom");
    treeString.insert("Adam");
    treeString.insert("Jones");
    treeString.insert("Peter");
    treeString.insert("John");
    treeString.insert("Daniel");

    treeString.nonRecursiveInorder();
  }
